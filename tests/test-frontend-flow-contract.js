...
assert(js.includes("const optionKeys = Object.keys(MAGIC_ART_PATHS)") && js.includes("const selectedKeys = new Set(cards.map((card) => card.key))") && js.includes('data-magic-option="${key}"') && css.includes(".magic-draw-fan > span:nth-child(10)"), "magic draw must present all ten distinct magic options and mark the two already-selected results without redrawing them");
...
assert(html.includes("src/core/boss-duel-poker-arrangement-core.js?v=frontend-v92") && html.includes("src/core/boss-duel-rules.js?v=frontend-v92") && html.includes("src/core/boss-duel-natural-story-core.js?v=frontend-v92") && html.includes("src/game/boss-duel-demo.js?v=frontend-v92") && html.includes("src/game/boss-duel-demo.css?v=frontend-v92"), "Demo code, shared arrangement, and live story assets must share the v92 cache key");
...
assert(toolHtml.includes('href="%E9%81%8A%E6%88%B2Demo.html?v=frontend-v92"'), "probability tool must keep a direct link to the current frontend Demo");
