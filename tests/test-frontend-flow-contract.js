...
assert(html.includes("src/core/boss-duel-poker-arrangement-core.js?v=frontend-v96") && html.includes("src/core/boss-duel-rules.js?v=frontend-v96") && html.includes("src/core/boss-duel-natural-story-core.js?v=frontend-v96") && html.includes("src/game/boss-duel-demo.js?v=frontend-v96") && html.includes("src/game/boss-duel-demo.css?v=frontend-v96"), "Demo code, shared arrangement, and live story assets must share the v96 cache key");
...
assert(html.includes("src/core/boss-duel-story-planner.js?v=boss-plan-v11") && html.includes("data/story/boss-duel-story-preset-v1.js?v=story-catalog-v14"), "Demo must load the planner and freshly regenerated 240,000-story seed preset");
...
assert(toolHtml.includes('href="%E9%81%8A%E6%88%B2Demo.html?v=frontend-v96"'), "probability tool must keep a direct link to the current frontend Demo");
