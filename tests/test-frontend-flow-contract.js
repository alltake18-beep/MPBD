...
assert(html.includes("src/core/boss-duel-poker-arrangement-core.js?v=frontend-v88") && html.includes("src/core/boss-duel-rules.js?v=frontend-v88") && html.includes("src/core/boss-duel-natural-story-core.js?v=frontend-v88") && html.includes("src/game/boss-duel-demo.js?v=frontend-v88") && html.includes("src/game/boss-duel-demo.css?v=frontend-v88"), "Demo code, shared arrangement, and live story assets must share the v88 cache key");
...
assert(toolHtml.includes('href="%E9%81%8A%E6%88%B2Demo.html?v=frontend-v88"'), "probability tool must keep a direct link to the current frontend Demo");
