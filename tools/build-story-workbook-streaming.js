...
async function buildSummarySheet(statsRows) {
  ...
  rows.push(`<row r="2">${stringCell("A2", "版本：frontend-v102／action-tree-v60／boss-plan-v11／arrange-v10／natural-story-preset-v14；24 個結果資料格各 10,000；同一 X 倍數劇本通用所有 Bet。", 2)}</row>`);
