...
summary.getRange("A2").values = [["版本：frontend-v84／action-tree-v29／boss-plan-v10／arrange-v9／natural-story-preset-v10　分類：贏多 ≥3x；贏少 ≥1x 且 <3x；輸 <1x；配籤：目標 RTP 差額分數／1,000,000張整數籤"]];
