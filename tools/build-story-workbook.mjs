...
summary.getRange("A2").values = [["版本：frontend-v87／action-tree-v31／boss-plan-v10／arrange-v9／natural-story-preset-v10　分類：贏多 ≥3x；贏少 ≥1x 且 <3x；輸 <1x；24 個結果資料格各 10,000；同一 X 倍數劇本通用所有 Bet"]];
