...
const CurrentPreset = require("../boss-duel-story-preset-v1.js");
const CurrentSummaryPreset = require("../boss-duel-story-summary-preset-v1.js");
...
async function main() {
  ...
  assert.equal(Generator.FORMAL_TICKET_GROUPS_PER_STAR, 256);
  ...
  Generator.attachCompatibilityTicketGroups(smallProfile, built.preset, built.summaryPreset, { groupTarget: 1 });
  assert.equal(built.preset.ticketGroupVersion, "score-ticket-groups-v3");
  assert.equal(built.preset.ticketGroups[8].length, 1);
